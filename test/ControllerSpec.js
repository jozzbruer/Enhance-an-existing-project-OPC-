...
describe('controller', function () {
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			// TODO: write test
			var todo = {id: 42, title: 'new todo', completed: true};
			setUpModel([todo]);
		...
		it('should update the view', function () {
			// TODO: write test
			var todo = {id: 42, title: 'new todo', completed: false};
			setUpModel([todo]);
			subject.setView('');
	...
	describe('new todo', function () {
		it('should add a new todo to the model', function () {
			// TODO: write test (add empty todo and call add item to create a new one)
			//var todo = {title: 'new  todo'}
			setUpModel([])
			subject.setView('');
